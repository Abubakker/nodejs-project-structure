...
route.get('/get-${route_name}',controller('${controller_name}/index'))
route.post('/save-${route_name}',controller('${controller_name}/save'))
route.post('/update-${route_name}/:id',controller('${controller_name}/update'))
route.get('/get-${route_name}/:id',controller('${controller_name}/show'))
route.post('/delete-${route_name}/:id',controller('${controller_name}/delete'))
`;
    return `//${route_name}
route.get('/${route_name}',controller('${controller_name}/index'))
route.get('/${route_name}/create',controller('${controller_name}/create'))
route.post('/${route_name}/create',controller('${controller_name}/save'))
