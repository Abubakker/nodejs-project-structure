    ...
    */
    ...
    sanitize() {
        ...
        if (this.item == 'model') {
            ...
            this.table_name = pluralize(file_name);
            let date = new Date();
            ...
            file_name = prefix + '_' + action + '_table_' + this.table_name;
            this.migration_target = action;
        }
    ...
    */
    ...
    execute() {
        ...
        if (content == "") {
            ...
            else if (this.item == 'migration') content = utils.getMigrationCodes(this.table_name, this.descriptions, this.migration_target);
